...
HD_PWD='C:/Users/ahmcg/MAPS_ASIC_Behavioral/MAPS_ASIC_Behavioral.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MAPS_ASIC_Behavioral.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MAPS_ASIC_Behavioral.tcl
